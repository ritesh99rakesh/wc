...
hidden if the `wc_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `wc_DEVELOPER_MODE` to the configure
...
Runs the executable target `wc_exe`.
